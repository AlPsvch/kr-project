...
Детали услуг.  
![Services_details](../../pictures/mockups/services_details.png)  
Окно отображения цен на услуги.  
![Prices](../../pictures/mockups/prices.png)  
Окно портфолио сервиса.  
![Portfolio](../../pictures/mockups/portfolio.png)  
Детали портфолио сервиса.  
![Portfolio_details](../../pictures/mockups/portfolio_details.png)  
...
Люди среднего возраста, нуждающиеся в дизайне, ремонте или постройке домов, коттеджей, квартир и др.
...
#### 3.1.1.1 Выбор услуг
**Описание.** Пользователь имеет возможность найти нужную ему услугу, посмотреть доступных мастеров, работающих в данном направлении и посмотреть цены, перейдя по ссылке.

| Функция | Требования | 
|:---|:---|
| Открытие деталей услуги | Приложение должно предоставить возможность детального рассмотрения выбранной услуги, с ее описанием и отображением доступных мастеров |
| Просмотр цены на услуги | Приложение должно предоставить пользователю возможность просматривать подробные цены услуг, после перехода пользователя по ссылке |

<a name="check_portfolio"/>

#### 3.1.1.2 Просмотр портфолио
**Описание.** Пользователь имеет возможность просмотреть портфолио с перечнем выполненных работ мастерами сервиса.
 
| Функция | Требования | 
|:---|:---|
| Открытие страницы portfolio | Приложение должно выводить краткую информацию по выполненным работам |
| Открытие подробной информации | Приложение должно при нажатии на любое портфолио открывать страницу с подробной информацией о сделанной работе, фотографиями и пометкой, какой мастер выполнял эту работу |
